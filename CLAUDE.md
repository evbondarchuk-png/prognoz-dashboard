...
**Открыто на потом:** включить триггер `roster-reconcile`; разобрать почему 126
старых кодов годами не было в `/users`; учитывать ли новичков (is_newbie) в
агрегатах группы (сейчас `aggregates.js:143` их исключает).
